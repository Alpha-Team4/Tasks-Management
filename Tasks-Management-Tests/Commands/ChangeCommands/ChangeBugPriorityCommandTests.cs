...
namespace TasksManagement_Tests.Commands.ChangeCommands
{
    ...
    public class ChangeBugPriorityCommandTests
    {
        ...
        public void Constructor_InitializesCommand()
        {
            ...
            var sut = new ChangeBugPriorityCommand(testParams, testRepo);

            Assert.IsInstanceOfType(sut, typeof(ChangeBugPriorityCommand));
        }
        ...
        public void Execute_ChangesStoryPriority()
        {
            ...
            var expectedOutput = $"Bug '{TaskData.ValidTitle}' priority changed to '{Priority.High}'.";
